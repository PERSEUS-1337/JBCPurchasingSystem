...
//         );
//         expect(resultData.emails).toBe(validSupplierComplete.emails);
...
//         expect(resultData.supplies).toBe(validSupplierComplete.supplies);
//         expect(resultData.documentation).toBe(
...
//         expect(errorMessage).toContain(`Required at "status"`);
//       }
//     });
