...
- Purchase Request (PR) Module: [DOCS_PR.md](DOCS_PR.md)
...
> _Defines the actual data models per entity. Focuses on field names, data types, optionality, enums, validation rules._
...
>
> Each table contains _only essential fields_ (IDs, references, key metadata). Full schemas go into implementation docs or database references.
